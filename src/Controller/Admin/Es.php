...
class Es extends Auth
{
    ...
    public function dashboard()
    {
        ...
        $indexes = Be::getService('App.Search.Admin.Es')->getIndexes();
    ...
    public function createIndex()
    {
        ...
        try {
            Be::getService('App.Search.Admin.Es')->createIndex($indexName, $formData);
    ...
    public function deleteIndex()
    {
        ...
        $indexName = $formData['name'] ?? '';
        try {
            Be::getService('App.Search.Admin.Es')->deleteIndex($indexName);
